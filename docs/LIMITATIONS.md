...
| Reference | `docs/DECISIONS.md`, "GEAR v3 Phase 5: contextual validator layer (broad-impact only, PARTIAL)" (2026-09-14); "GEAR v3 Phase 5: physical-occurrence validator (IBTrACS)" (2026-09-15, Storm/landslide/lightning scoping); `src/index/contextual_validators.py`, `EMDAT_DISASTER_TYPE_TO_TERM` module docstring ("inherited UNCHANGED, an open item flagged"). |
